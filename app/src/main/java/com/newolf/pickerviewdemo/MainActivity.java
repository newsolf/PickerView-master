...
import com.newolf.pickerview.builder.OptionsPickerBuilder;
import com.newolf.pickerview.builder.TimePickerBuilder;
import com.newolf.pickerview.listener.CustomListener;
import com.newolf.pickerview.listener.OnCancelClickListener;
import com.newolf.pickerview.listener.OnConforClickListener;
import com.newolf.pickerview.listener.OnOptionsSelectChangeListener;
import com.newolf.pickerview.listener.OnOptionsSelectListener;
import com.newolf.pickerview.listener.OnTimeSelectChangeListener;
import com.newolf.pickerview.listener.OnTimeSelectListener;
import com.newolf.pickerview.view.BasePickerView;
import com.newolf.pickerview.view.OptionsPickerView;
import com.newolf.pickerview.view.TimePickerView;
import com.newolf.pickerviewdemo.bean.CardBean;
import com.newolf.pickerviewdemo.bean.ProvinceBean;
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                makeText(MainActivity.this, getTime(date), LENGTH_SHORT).show();
            }
        })
    ...
    private void initTimePicker() {//Dialog 模式下，在底部弹出
        ...
        if (mDialog != null) {
            ...
            if (dialogWindow != null) {
                dialogWindow.setWindowAnimations(com.newolf.pickerview.R.style.picker_view_slide_anim);//修改动画样式
    ...
    private void initOptionPicker() {//条件选择器初始化
        ...
        pvOptions = new OptionsPickerBuilder(this, new OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setCancelTextOnClickListener(new OnCancelClickListener() {
                    @Override
                    public void onClick(BasePickerView view) {
                        makeText(MainActivity.this, "就是不让你取消,哈哈...", LENGTH_SHORT).show();
                    }
                })
                .setSubmitOnClickListener(new OnConforClickListener() {
                    @Override
                    public void onClick(BasePickerView view) {
                        if (mTx.contains("北京")){
                            view.dismiss();
                        }else{
                            makeText(MainActivity.this, "请选择北京的城市", LENGTH_SHORT).show();
                        }
                    }
                })
                .build();
