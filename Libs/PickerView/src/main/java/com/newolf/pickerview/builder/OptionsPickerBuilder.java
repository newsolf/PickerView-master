package com.newolf.pickerview.builder;

import android.content.Context;
import android.graphics.Typeface;
import android.view.ViewGroup;

import com.newolf.pickerview.configure.PickerOptions;
...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder setSubmitOnClickListener(OnConforClickListener listener) {
        mPickerOptions.textContentConfirmOnClickListener = listener;
        return this;
    }
    ...
    public OptionsPickerBuilder setCancelTextOnClickListener(OnCancelClickListener listener) {
        mPickerOptions.setTextContentCancelOnClickListener(listener);
        return this;
    }
    ...
    public OptionsPickerBuilder setVisibleItemCount(int count) {
        if (count < 0) {
            throw new RuntimeException("count must be > 0");
        }

        if (count % 2 == 0) {
            throw new RuntimeException("count must be %2 !=0");
        }
        mPickerOptions.itemsVisible = count ;
        return this;
    }
}
