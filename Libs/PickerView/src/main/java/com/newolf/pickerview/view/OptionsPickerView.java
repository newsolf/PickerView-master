package com.newolf.pickerview.view;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            if (mPickerOptions.textContentConfirmOnClickListener != null) {
                btnSubmit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        returnData();
                        mPickerOptions.textContentConfirmOnClickListener.onClick(OptionsPickerView.this);
                    }
                });
            } else {
            ...
            if (mPickerOptions.textContentCancelOnClickListener != null) {
                btnCancel.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        returnData();
                        mPickerOptions.textContentCancelOnClickListener.onClick(OptionsPickerView.this);
                    }
                });
            } else {
        ...
        if (mPickerOptions.itemsVisible != 0){
            wheelOptions.itemsVisible = mPickerOptions.itemsVisible;
        }
